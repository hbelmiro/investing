...
@ApplicationScoped
public final class UsReitsBuyReader extends OperationReader {

    /**
     * @deprecated must be used only by CDI
     */
    @Deprecated(forRemoval = true)
    private UsReitsBuyReader() {
    }

    @Inject
    UsReitsBuyReader(GoogleSheetsClient googleSheetsClient) {
        super("Compras REITS", googleSheetsClient, OperationType.BUY, MoneyUtil.USD);
    }
}
