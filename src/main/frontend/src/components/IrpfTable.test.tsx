...
describe('IrpfTable', () => {
  const sampleData: IrpfResponse = [
    { symbol: 'AAPL', quantity: 12, avgCostUsd: 53.39, totalCostUsd: 640.68, avgCostBrl: 290.29, totalCostBrl: 3483.48, ptaxRate: 5.4369, capitalGainsBrl: 328.23, totalCapitalGainsBrl: 328.23, dividendsGrossBrl: 4.53, dividendsTaxBrl: 0.3 },
